...
const EditUser = () => {
  ...
  const handleSave = () => {
    ...
    const isUsernameTaken = users.some(
      (user) => user.username === userData.username && user.username !== username
    );
    ...
    const isUsernameTakenByAdmin = adminData?.username === userData.username && username !== adminData.username;
    const isEmailTakenByAdmin = adminData?.email === userData.email && username !== adminData.username;
